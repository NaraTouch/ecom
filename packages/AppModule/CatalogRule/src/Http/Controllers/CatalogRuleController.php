...
namespace AppModule\CatalogRule\Http\Controllers;

use Illuminate\Http\Request;
use Illuminate\Support\Facades\Event;
use AppModule\Admin\DataGrids\CatalogRuleDataGrid;
use AppModule\CatalogRule\Helpers\CatalogRuleIndex;
use AppModule\CatalogRule\Http\Requests\CatalogRuleRequest;
use AppModule\CatalogRule\Repositories\CatalogRuleRepository;
...
class CatalogRuleController extends Controller
{
     ...
     *
     * @param  \AppModule\CatalogRule\Repositories\CatalogRuleRepository  $catalogRuleRepository
     ...
     *
     * @param  \AppModule\CatalogRule\Http\Requests\CatalogRuleRequest  $catalogRuleRequest
     * @return \Illuminate\Http\Response
     */
