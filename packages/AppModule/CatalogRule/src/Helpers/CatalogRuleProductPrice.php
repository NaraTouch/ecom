...
use AppModule\CatalogRule\Repositories\CatalogRuleProductPriceRepository;
...
class CatalogRuleProductPrice
{
     ...
     *
     * @var \AppModule\Customer\Contracts\CustomerGroup
     */
     ...
     *
     * @param  \AppModule\Attribute\Repositories\CatalogRuleProductPriceRepository  $catalogRuleProductPriceRepository
     * @param  \AppModule\CatalogRule\Repositories\CatalogRuleProduct  $catalogRuleProductHelper
     ...
     * Set customer group
     *
     * @param  \AppModule\Customer\Contracts\CustomerGroup  $customerGroup
     * @return \AppModule\Product\Helpers\ProductPriceIndex\AbstractPriceIndex
     */
     ...
     *
     * @param  array  $rule
     * @param  \AppModule\Product\Contracts\Product|null  $productData
     * @return float
     */
