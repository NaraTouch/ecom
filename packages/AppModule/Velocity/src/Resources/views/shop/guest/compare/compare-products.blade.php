@php
    $attributeRepository = app('\AppModule\Attribute\Repositories\AttributeFamilyRepository');
    $comparableAttributes = $attributeRepository->getComparableAttributesBelongsToFamily();

    $locale = core()->getRequestedLocaleCode();

    $attributeOptionTranslations = app('\AppModule\Attribute\Repositories\AttributeOptionTranslationRepository')->where('locale', $locale)->get();
@endphp
                                    ...
                                    @case('product_image')
                                        <a :href="`${$root.baseUrl}/${product.url_key}`" class="unset">
                                            <img
                                                ...
                                                :onerror="`this.src='${$root.baseUrl}/vendor/AppModule/ui/assets/images/product/large-product-placeholder.png'`"
                                                alt=""/>
                                        </a>
                                        @break
