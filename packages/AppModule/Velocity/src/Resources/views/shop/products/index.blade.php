...
@section('seo')
    ...
    @if (core()->getConfigData('catalog.rich_snippets.categories.enable'))
        <script type="application/ld+json">
            {!! app('AppModule\Product\Helpers\SEO')->getCategoryJsonLd($category) !!}
        </script>
    @endif
@stop
                                    ...
                                    <slide slot="slide-{{ $index }}">
                                        <div class='childSubCategory'>
                                            <a href='{{ url($childSubCategory->url_path) }}'>
                                                <div>
                                                    <img src='{{ $childSubCategory->getImageUrlAttribute()?? url("/vendor/AppModule/ui/assets/images/product/small-product-placeholder.png") }}'>
