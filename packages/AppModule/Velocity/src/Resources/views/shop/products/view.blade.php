...
@inject ('customHelper', 'AppModule\Velocity\Helpers\Helper')
...
@section('seo')
    ...
    @if (core()->getConfigData('catalog.rich_snippets.products.enable'))
        <script type="application/ld+json">
            {!! app('AppModule\Product\Helpers\SEO')->getProductJsonLd($product) !!}
        </script>
    @endif
                            ...
                            <div class="right col-lg-7 col-md-6">
                                ...
                                <div class="info">
                                    ...
                                    <div class="col-12 price">
                                        ...
                                        @if (
                                            AppModule\Tax\Helpers\Tax::isTaxInclusive()
