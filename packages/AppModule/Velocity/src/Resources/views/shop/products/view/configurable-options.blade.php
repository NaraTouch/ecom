@if (AppModule\Product\Helpers\ProductType::hasVariants($product->type))
    @php
        $defaultVariant = $product->getTypeInstance()->getDefaultVariant();

        $config = app('AppModule\Product\Helpers\ConfigurableOption')->getConfigurationConfig($product);
