            ...
            <div class="product-image">
                <a
                    ...
                    <img
                        ...
                        :onerror="`this.src='${this.$root.baseUrl}/vendor/AppModule/ui/assets/images/product/large-product-placeholder.png'`" alt="" />
        ...
        <div class="card grid-card product-card-new">
            <a
                ...
                <img
                    ...
                    :onerror="`this.src='${this.$root.baseUrl}/vendor/AppModule/ui/assets/images/product/large-product-placeholder.png'`" />
