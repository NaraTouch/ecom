...
class ContentRepository extends Repository
{
    ...
    {
        return 'AppModule\Velocity\Contracts\Content';
    }

    /**
     * @param  array  $data
     * @return \AppModule\Velocity\Models\Content
     */
    ...
    public function getAllContents()
    {
        ...
        $velocityMetaData = app('AppModule\Velocity\Helpers\Helper')->getVelocityMetaData();
