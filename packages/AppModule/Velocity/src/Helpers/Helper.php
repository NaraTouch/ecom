...
use AppModule\Product\Helpers\Review;
use AppModule\Attribute\Repositories\AttributeOptionRepository;
use AppModule\Product\Repositories\ProductRepository;
use AppModule\Product\Repositories\ProductReviewRepository;
use AppModule\Velocity\Repositories\OrderBrandsRepository;
use AppModule\Velocity\Repositories\VelocityMetadataRepository;
...
class Helper extends Review
{
     ...
     *
     * @param  \AppModule\Attribute\Repositories\AttributeOptionRepository  $attributeOptionRepository
     * @param  \AppModule\Velocity\Repositories\OrderBrandsRepository  $productRepository
     * @param  \AppModule\Product\Repositories\ProductReviewRepository  $productReviewRepository
     * @param  \AppModule\Product\Repositories\ProductRepository  $orderBrands
     * @param  \AppModule\Velocity\Repositories\VelocityMetadataRepository  $velocityMetadataRepository
     * @return void
     */
     ...
     *
     * @return \AppModule\Velocity\Repositories\VelocityMetadataRepository
     */
    ...
    {
        $reviewHelper = app('AppModule\Product\Helpers\Review');
