...
use AppModule\Checkout\Contracts\Cart as CartModel;
        ...
        try {
            ...
            if ($cart instanceof CartModel) {
                ...
                if ($customer = auth()->guard('customer')->user()) {
                    app('AppModule\Customer\Repositories\WishlistRepository')->deleteWhere(['product_id' => $id, 'customer_id' => $customer->id]);
                }
