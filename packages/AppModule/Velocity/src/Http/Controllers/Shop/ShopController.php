...
namespace AppModule\Velocity\Http\Controllers\Shop;
...
use AppModule\Velocity\Helpers\Helper;
use AppModule\Velocity\Repositories\VelocityCustomerCompareProductRepository as CustomerCompareProductRepository;
...
class ShopController extends Controller
{
     ...
     * @param  \AppModule\Velocity\Helpers\Helper  $velocityHelper,
     * @param  \AppModule\Velocity\Repositories\VelocityCustomerCompareProductRepository  $compareProductsRepository
     * @return void
     */
    ...
    public function fetchProductDetails($slug)
    {
        ...
        if ($product?->status) {
            $productReviewHelper = app('AppModule\Product\Helpers\Review');
