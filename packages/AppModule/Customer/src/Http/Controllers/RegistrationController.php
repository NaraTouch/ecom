...
use AppModule\Core\Repositories\SubscribersListRepository;
use AppModule\Customer\Http\Requests\CustomerRegistrationRequest;
use AppModule\Customer\Mail\RegistrationEmail;
use AppModule\Customer\Mail\VerificationEmail;
use AppModule\Customer\Repositories\CustomerGroupRepository;
use AppModule\Customer\Repositories\CustomerRepository;
use AppModule\Shop\Mail\SubscriptionEmail;
...
class RegistrationController extends Controller
{
     ...
     * @param  \AppModule\Core\Repositories\SubscribersListRepository  $subscriptionRepository
     * @return void
     */
     ...
     *
     * @param  \AppModule\Customer\Http\Requests\CustomerRegistrationRequest  $request
