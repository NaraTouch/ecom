...
class CustomerRepository extends Repository
{
    ...
    {
        return 'AppModule\Customer\Contracts\Customer';
    }

    /**
     * Check if customer has order pending or processing.
     *
     * @param  \AppModule\Customer\Models\Customer
     * @return boolean
     */
     ...
     *
     * @return \AppModule\Customer\Models\CustomerGroup
     */
     ...
     *
     * @param  array  $data
     * @param  \AppModule\Customer\Models\Customer  $customer
     * @param  string $type
     * @return void
     */
     ...
     *
     * @param  \AppModule\Customer\Contracts\Customer  $customer
     * @return mixed
     */
    public function syncNewRegisteredCustomerInformation($customer)
    {
        ...
        Order::where('customer_email', $customer->email)->update([
            ...
            'customer_type' => \AppModule\Customer\Models\Customer::class,
        ]);
