...
trait ProvideDataGridPlus
{
    ...
    public function getCurrentExtraFilterValue()
    {
        ...
        if ($channel !== 'all') {
            $channelLocales = app('AppModule\Core\Repositories\ChannelRepository')->findOneByField('code', $channel)->locales()->orderBy('name')->get();
     ...
     *
     * To Do (@devansh-AppModule): Use translation from JS method by encoding lang file.
     *
     * @return array
     */
