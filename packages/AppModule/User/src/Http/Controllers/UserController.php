...
namespace AppModule\User\Http\Controllers;

use Illuminate\Support\Facades\Event;
use Illuminate\Support\Facades\Hash;
use Illuminate\Support\Str;
use AppModule\Admin\DataGrids\UserDataGrid;
use AppModule\User\Http\Requests\UserForm;
use AppModule\User\Repositories\AdminRepository;
use AppModule\User\Repositories\RoleRepository;
...
class UserController extends Controller
{
     ...
     *
     * @param  \AppModule\User\Repositories\AdminRepository  $adminRepository
     * @param  \AppModule\User\Repositories\RoleRepository  $roleRepository
     * @return void
     */
     ...
     *
     * @param  \AppModule\User\Http\Requests\UserForm  $request
