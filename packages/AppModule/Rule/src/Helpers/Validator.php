...
namespace AppModule\Rule\Helpers;

use AppModule\Checkout\Facades\Cart;
use AppModule\Checkout\Contracts\Cart as CheckoutContract;
...
class Validator
{
     ...
     *
     * @param  \AppModule\CartRule\Contracts\CartRule|\AppModule\CatalogRule\Contracts\CatalogRule  $rule
     * @param  \AppModule\Checkout\Contracts\Cart|\AppModule\Checkout\Contracts\CartItem|\AppModule\Product\Contracts\Product  $entity
     * @return boolean
     */
     ...
     * @param  \AppModule\Checkout\Contracts\CartItem|\AppModule\Product\Contracts\Product  $entity
     * @return boolean
     */
     ...
     *
     * @param  array  $condition
     * @param  \AppModule\Checkout\Contracts\CartItem  $entity
     * @return bool
     */
     ...
     * @param  \AppModule\Checkout\Contracts\Cart|\AppModule\Checkout\Contracts\CartItem|\AppModule\Product\Contracts\Product  $item
     * @return array
     */
