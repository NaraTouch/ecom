...
namespace AppModule\CMS\Repositories;

use Illuminate\Database\Eloquent\ModelNotFoundException;
use AppModule\Core\Eloquent\Repository;
use AppModule\CMS\Models\CmsPageTranslationProxy;
...
class CmsRepository extends Repository
{
    ...
    {
        return 'AppModule\CMS\Contracts\CmsPage';
    }
     ...
     *
     * @param  string  $urlKey
     * @return \AppModule\CMS\Contracts\CmsPage|\Exception
     */
