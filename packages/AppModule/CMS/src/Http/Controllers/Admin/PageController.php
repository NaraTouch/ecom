...
namespace AppModule\CMS\Http\Controllers\Admin;

use Illuminate\Support\Facades\Event;
use AppModule\Admin\DataGrids\CMSPageDataGrid;
...
class PageController extends Controller
{
    ...
    public function store()
    {
        $this->validate(request(), [
            'url_key'      => ['required', 'unique:cms_page_translations,url_key', new \AppModule\Core\Contracts\Validations\Slug],
            'page_title'   => 'required',
            'channels'     => 'required',
    ...
    public function update($id)
    {
        ...
        $this->validate(request(), [
            $locale . '.url_key'      => ['required', new \AppModule\Core\Contracts\Validations\Slug, function ($attribute, $value, $fail) use ($id) {
