...
use AppModule\Category\Contracts\Category as CategoryContract;
use AppModule\Category\Database\Factories\CategoryFactory;
...
class Category extends TranslatableModel implements CategoryContract
{
     ...
     *
     * @param  \AppModule\Velocity\Contracts\Category[]  $categoryTree
     * @return \AppModule\Velocity\Contracts\Category
     */
