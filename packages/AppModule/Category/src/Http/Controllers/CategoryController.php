...
namespace AppModule\Category\Http\Controllers;

use Illuminate\Support\Facades\Event;
use AppModule\Admin\DataGrids\CategoryDataGrid;
use AppModule\Admin\DataGrids\CategoryProductDataGrid;
...
use AppModule\Category\Http\Requests\CategoryRequest;
...
class CategoryController extends Controller
{
     ...
     *
     * @param  \AppModule\Category\Http\Requests\CategoryRequest  $categoryRequest
