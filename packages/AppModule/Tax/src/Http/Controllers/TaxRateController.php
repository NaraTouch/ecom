...
namespace AppModule\Tax\Http\Controllers;

use Illuminate\Support\Facades\Event;
use Illuminate\Support\Facades\Validator;
use Maatwebsite\Excel\Validators\Failure;
use AppModule\Admin\DataGrids\TaxRateDataGrid;
use AppModule\Admin\Imports\DataGridImport;
use AppModule\Tax\Repositories\TaxRateRepository;
...
class TaxRateController extends Controller
{
     ...
     *
     * @param  \AppModule\Tax\Repositories\TaxRateRepository  $taxRateRepository
     * @return void
     */
