...
namespace AppModule\Marketing\Helpers;

use Carbon\Carbon;
use Illuminate\Support\Facades\Mail;
use AppModule\Core\Models\SubscribersList;
use AppModule\Marketing\Mail\NewsletterMail;
use AppModule\Marketing\Repositories\EventRepository;
use AppModule\Marketing\Repositories\CampaignRepository;
...
class Campaign
{
     ...
     *
     * @param  \AppModule\Marketing\Repositories\EventRepository  $eventRepository
     * @param  \AppModule\Marketing\Repositories\CampaignRepository  $campaignRepository
     *
     * @return void
     */
     ...
     *
     * @param  \AppModule\Marketing\Contracts\Campaign  $campaign
     * @return array
     */
