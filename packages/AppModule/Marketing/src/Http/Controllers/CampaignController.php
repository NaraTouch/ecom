...
namespace AppModule\Marketing\Http\Controllers;

use Illuminate\Support\Facades\Event;
use AppModule\Admin\DataGrids\CampaignDataGrid;
use AppModule\Marketing\Repositories\CampaignRepository;
use AppModule\Marketing\Repositories\TemplateRepository;
...
class CampaignController extends Controller
{
     ...
     * @param  \AppModule\Marketing\Repositories\TemplateRepository  $templateRepository
     * @return void
     */
