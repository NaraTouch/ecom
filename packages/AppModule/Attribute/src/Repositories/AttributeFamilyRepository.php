...
use AppModule\Attribute\Repositories\AttributeGroupRepository;
...
class AttributeFamilyRepository extends Repository
{
     ...
     * @param  \AppModule\Attribute\Repositories\AttributeGroupRepository  $attributeGroupRepository
    ...
    {
        return 'AppModule\Attribute\Contracts\AttributeFamily';
    }
