...
namespace AppModule\Inventory\Http\Controllers;

use Illuminate\Support\Facades\Event;
use AppModule\Admin\DataGrids\InventorySourcesDataGrid;
use AppModule\Inventory\Http\Requests\InventorySourceRequest;
