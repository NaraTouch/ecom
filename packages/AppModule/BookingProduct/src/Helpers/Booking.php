...
use AppModule\BookingProduct\Repositories\BookingProductDefaultSlotRepository;
use AppModule\BookingProduct\Repositories\BookingProductAppointmentSlotRepository;
use AppModule\BookingProduct\Repositories\BookingProductEventTicketRepository;
use AppModule\BookingProduct\Repositories\BookingProductRentalSlotRepository;
use AppModule\BookingProduct\Repositories\BookingProductTableSlotRepository;
...
class Booking
{
     ...
     * @param  \AppModule\BookingProduct\Repositories\BookingProductDefaultSlotRepository  $bookingProductDefaultSlotRepository
     * @param  \AppModule\BookingProduct\Repositories\BookingProductAppointmentSlotRepository  $bookingProductAppointmentSlotRepository
     * @param  \AppModule\BookingProduct\Repositories\BookingProductEventTicketRepository  $bookingProductEventTicketRepository
     * @param  \AppModule\BookingProduct\Repositories\BookingProductRentalSlotRepository  $bookingProductRentalSlotRepository
     * @param  \AppModule\BookingProduct\Repositories\BookingProductTableSlotRepository  $bookingProductTableSlotRepository
     * @param  \AppModule\BookingProduct\Repositories\BookingRepository  $bookingRepository
     * @return void
     */
    ...
    /**
     * @param  \AppModule\Checkout\Contracts\CartItem|array  $cartItem
     * @return bool
     */
     ...
     * @return bool
     */
    public function isCartItemInactive(\AppModule\Checkout\Contracts\CartItem $item): bool
    {
