...
namespace AppModule\BookingProduct\Type;

use Illuminate\Support\Arr;
use Carbon\Carbon;
use AppModule\Product\Type\Virtual;
...
use AppModule\BookingProduct\Helpers\Booking as BookingHelper;
use AppModule\Checkout\Models\CartItem;
use AppModule\Product\DataTypes\CartItemValidationResult;
use AppModule\Product\Helpers\Indexers\Price\Virtual as VirtualIndexer;
...
class Booking extends Virtual
{
     ...
     * @param  \AppModule\BookingProduct\Helpers\BookingHelper  $bookingHelper
     * @return void
     */
