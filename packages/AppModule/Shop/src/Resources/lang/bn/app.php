...
return [
    ...
    'reviews' => [
        ...
        'ratingreviews'             => ':rating রেটিং এবং :review রিভিউ',
        'star'                      => 'তারকা',
        'percentage'                => ':শতাংশ %',
        'id-star'                   => 'তারকা',
        'name'                      => 'নাম',
        'login-to-review'           => 'দয়া করে প্রথমে লগইন করুন পণ্য পর্যালোচনা করতে।',
    ],
    ...
    'customer' => [
        ...
        'signup-text' => [
            'account_exists' => 'ইতিমধ্যে একটি সদস্যপদ আছে',
            'title'          => 'সাইন ইন করুন',
        ],
        ...
        'login-form' => [
            ...
            'footer'              => '© কপিরাইট :year ওয়েবকুল সফটওয়্যার, সর্বস্বত্ব সংরক্ষিত',
        ...
        'account' => [
            ...
            'order' => [
                ...
                'view' => [
                    ...
                    'item-shipped'        => 'চালিত (: qty_shipped)',
            ...
            'wishlist' => [
                ...
                'enable'               => 'সক্ষম',
                'disable'              => 'অক্ষম করুন',
                'customer-name'        => ":name\'s শেয়ার করা ইচ্ছা তালিকা",
    ...
    'products' => [
        ...
        'show'                     => 'দেখাও',
        'pager-info'               => 'দেখানো হচ্ছে :total আইটেমগুলির মধ্যে দেখানো হচ্ছে',
        'description'              => 'বর্ণনা',
        'specification'            => 'স্পেসিফিকেশন',
        'total-reviews'            => ':total পর্যালোচনা',
    ...
    'checkout' => [
        'cart' => [
            ...
            'confirm-action'            => 'এই কর্ম নিশ্চিত?',
    ...
    'AppModule' => [
        'copy-right' => '© কপিরাইট :year ওয়েবকুল সফটওয়্যার, সর্বস্বত্ব সংরক্ষিত',
    ],
