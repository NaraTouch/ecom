...
use AppModule\Customer\Http\Controllers\AccountController;
use AppModule\Customer\Http\Controllers\AddressController;
use AppModule\Customer\Http\Controllers\CustomerController;
use AppModule\Customer\Http\Controllers\ForgotPasswordController;
use AppModule\Customer\Http\Controllers\RegistrationController;
use AppModule\Customer\Http\Controllers\ResetPasswordController;
use AppModule\Customer\Http\Controllers\SessionController;
use AppModule\Customer\Http\Controllers\WishlistController;
use AppModule\Shop\Http\Controllers\DownloadableProductController;
use AppModule\Shop\Http\Controllers\OrderController;
