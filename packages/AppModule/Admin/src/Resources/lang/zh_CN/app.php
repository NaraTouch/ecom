...
return [
    ...
    'account' => [
        ...
        'save-btn-title'       => '保存',
        'general'              => '一般的',
        'upload-image-info'    => '上传 PNG 或 JPG 格式的个人资料图片（100px x 100px）',
        'remove-image'         => '删除图像',
        'image-upload-message' => '仅允许使用图像（.jpeg、.jpg、.png、..）。',
        'name'                 => '名称',
        'email'                => '电子邮件',
        'password'             => '密码',
    ...
    'sales' => [
        ...
        'transactions' => [
            ...
            'response'            => [
                ...
                'already-paid'      => '此发票已支付',
                'transaction-amount-exceeds' => '此交易的指定金额超过发票的总金额。',
                'transaction-amount-zero' => '交易金额可以为零或更少',
            ],
        ],
    ],
    ...
    'catalog' => [
        'products' => [
            ...
            'validations'                   => [
                'quantity-required' => '数量是必需的。',
                'quantity-integer'  => '数量应该是整数。',
                'quantity-min-zero' => '数量应大于零。',
            ],
            'video-size'                    => '最大视频大小应该是：size',
            'pending-ordered-qty'           => '待定订单数量: :qty',
            'pending-ordered-qty-info'      => '待定订单数量将在发货后从相应的库存来源中扣除。如果取消待定数量将可供出售。',
        ],
        ...
        'families'   => [
            ...
            'groups'               => '客户群',
            'add-group-title'      => '添加群',
            'edit-group-title'     => '编辑组',
            'update-group-title'   => '更新组',
            'position'             => '位置',
            'attribute-code'       => '代码',
            'type'                 => '类型',
    ...
    'settings' => [
        ...
        'channels'          => [
            ...
            'description'            => '描述',
            'hostname'               => '主机名',
            'hostname-placeholder'   => 'https://www.qhfood.com (最后不要加斜线。)',
    ...
    'marketing' => [
        ...
        'sitemaps' => [
            ...
            'path'           => '小路',
            'path-info'      => '示例：“/sitemap/”或“/”表示基本路径',
            'create-success' => '站点地图创建成功。',
            'update-success' => '站点地图更新成功。',
            'delete-success' => '站点地图已成功删除。',
        ],
    ],
