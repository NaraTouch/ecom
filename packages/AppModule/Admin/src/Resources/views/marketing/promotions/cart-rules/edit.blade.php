...
@push('scripts')
            ...
            <form method="POST" action="{{ route('admin.cart_rules.update', $cartRule->id) }}" @submit.prevent="onSubmit">
                ...
                <div class="page-content">
                    <div class="form-container">
                        ...
                        {!! view_render_event('module.admin.promotions.cart-rules.create.before') !!}
                            ...
                            <div slot="body">
                                ...
                                <div class="control-group" :class="[errors.has('customer_groups[]') ? 'has-error' : '']">
                                    ...
                                    <select class="control" id="customer_groups" name="customer_groups[]" v-validate="'required'" data-vv-as="&quot;{{ __('admin::app.promotions.cart-rules.customer-groups') }}&quot;" multiple="multiple">
                                        ...
                                        @foreach(app('AppModule\Customer\Repositories\CustomerGroupRepository')->all() as $customerGroup)
                        ...
                        {!! view_render_event('module.admin.promotions.cart-rules.create.after') !!}
    ...
    @push('scripts')
        @include('admin::export.export', ['gridName' => app('AppModule\Admin\DataGrids\CartRuleCouponDataGrid')])
    @endpush
    ...
    <script>
        ...
        Vue.component('cart-rule-condition-item', {
            ...
            data: function() {
                return {
                    condition_attributes: @json(app('\AppModule\CartRule\Repositories\CartRuleRepository')->getConditionAttributes()),
