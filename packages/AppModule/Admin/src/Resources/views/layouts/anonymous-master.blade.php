...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        @else
            <link rel="icon" sizes="16x16" href="{{ asset('vendor/AppModule/ui/assets/images/favicon.ico') }}" />
        @endif

        <link rel="stylesheet" href="{{ asset('vendor/AppModule/admin/assets/css/admin.css') }}">
    ...
    <body @if (core()->getCurrentLocale() && core()->getCurrentLocale()->direction == 'rtl') class="rtl" @endif style="scroll-behavior: smooth;">
            ...
            <div class="center-box">
                ...
                <div class="adjacent-center">
                    ...
                    <div class="brand-logo">
                        ...
                        @else
                            <img src="{{ asset('vendor/AppModule/ui/assets/images/logo.png') }}" alt="{{ config('app.name') }}"/>
                        @endif
                    </div>
        ...
        <script type="text/javascript" src="{{ asset('vendor/AppModule/admin/assets/js/admin.js') }}"></script>
