{!! view_render_event('module.admin.catalog.product.edit_form_accordian.product_links.before', ['product' => $product]) !!}
        ...
        methods: {
            ...
            search: function (key) {
                ...
                if (this.search_term[key].length >= 1) {
                    this.$http.get ("{{ route('admin.catalog.products.product_link_search') }}", {params: {query: this.search_term[key]}})
