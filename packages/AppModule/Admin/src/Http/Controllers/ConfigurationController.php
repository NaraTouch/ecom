...
namespace AppModule\Admin\Http\Controllers;

use Illuminate\Support\Facades\Storage;
use AppModule\Core\Repositories\CoreConfigRepository;
use AppModule\Admin\Http\Requests\ConfigurationForm;
use AppModule\Core\Tree;
...
class ConfigurationController extends Controller
{
     ...
     *
     * @param  \AppModule\Admin\Http\Requests\ConfigurationForm  $request
