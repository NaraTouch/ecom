...
namespace AppModule\Admin\Http\Controllers\Customer;

use Illuminate\Support\Facades\Event;
use Illuminate\Support\Facades\Mail;
use AppModule\Admin\Http\Controllers\Controller;
use AppModule\Admin\DataGrids\CustomerDataGrid;
use AppModule\Admin\DataGrids\CustomerOrderDataGrid;
use AppModule\Admin\DataGrids\CustomersInvoicesDataGrid;
use AppModule\Admin\Mail\NewCustomerNotification;
...
class CustomerController extends Controller
{
     ...
     *
     * @param  int  $id
     * @return \AppModule\Admin\DataGrids\CustomersInvoicesDataGrid
     */
     ...
     *
     * @param  int  $id
     * @return \AppModule\Admin\DataGrids\CustomerOrderDataGrid
     */
