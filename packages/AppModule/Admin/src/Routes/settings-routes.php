...
use AppModule\Core\Http\Controllers\ChannelController;
use AppModule\Core\Http\Controllers\CurrencyController;
use AppModule\Core\Http\Controllers\ExchangeRateController;
use AppModule\Core\Http\Controllers\LocaleController;
use AppModule\Core\Http\Controllers\SliderController;
use AppModule\Inventory\Http\Controllers\InventorySourceController;
use AppModule\Tax\Http\Controllers\TaxCategoryController;
use AppModule\Tax\Http\Controllers\TaxRateController;
use AppModule\User\Http\Controllers\RoleController;
use AppModule\User\Http\Controllers\UserController;
