...
use AppModule\Admin\DataGrids\ChannelDataGrid;
...
class ChannelController extends Controller
{
    ...
    public function store()
    {
        $data = $this->validate(request(), [
            /* general */
            'code'                  => ['required', 'unique:channels,code', new \AppModule\Core\Contracts\Validations\Code],
            'name'                  => 'required',
    ...
    public function update($id)
    {
        ...
        $data = $this->validate(request(), [
            /* general */
            'code'                             => ['required', 'unique:channels,code,' . $id, new \AppModule\Core\Contracts\Validations\Code],
