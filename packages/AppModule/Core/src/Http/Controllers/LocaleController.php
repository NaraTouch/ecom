...
use AppModule\Admin\DataGrids\LocalesDataGrid;
...
class LocaleController extends Controller
{
    ...
    public function store()
    {
        $this->validate(request(), [
            'code'      => ['required', 'unique:locales,code', new \AppModule\Core\Contracts\Validations\Code],
            'name'      => 'required',
    ...
    {
        $this->validate(request(), [
            'code'      => ['required', 'unique:locales,code,' . $id, new \AppModule\Core\Contracts\Validations\Code],
            'name'      => 'required',
            'direction' => 'in:ltr,rtl',
        ]);
