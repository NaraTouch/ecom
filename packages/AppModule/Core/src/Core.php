...
class Core
{
     ...
     * Channel.
     *
     * @var \AppModule\Core\Models\Channel
     */
     ...
     * Currency.
     *
     * @var \AppModule\Core\Models\Currency
     */
     ...
     * @param  \AppModule\Core\Repositories\CurrencyRepository  $currencyRepository
     * @param  \AppModule\Core\Repositories\ExchangeRateRepository  $exchangeRateRepository
     ...
     * @param  \AppModule\Core\Repositories\CoreConfigRepository  $coreConfigRepository
     * @return void
     */
     ...
     *
     * @return \AppModule\Core\Contracts\Channel
     */
     ...
     *
     * @return \AppModule\Core\Contracts\locale
     */
     ...
     *
     * @return \AppModule\Core\Models\Currency
     */
     ...
     *
     * @return \AppModule\Core\Contracts\Currency
     */
     ...
     *
     * @param  string|\AppModule\Core\Contracts\Currency  $currency
     * @return string
     */
    public function currencySymbol($currency)
    {
        $code = $currency instanceof \AppModule\Core\Contracts\Currency ? $currency->code : $currency;
     ...
     *
     * @param  int|string|\AppModule\Core\Contracts\Channel  $channel
