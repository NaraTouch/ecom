...
use AppModule\Product\Repositories\ProductPriceIndexRepository;
...
class Price extends AbstractIndexer
{
     ...
     * @param  \AppModule\Product\Repositories\ProductPriceIndexRepository  $productPriceIndexRepository
     * @return void
     */
