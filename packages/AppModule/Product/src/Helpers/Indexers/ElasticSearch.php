...
class ElasticSearch extends AbstractIndexer
{
     ...
     * Locale instance.
     *
     * @var \AppModule\Core\Contracts\Locale
     */
    protected $locale;
     ...
     * @param  \AppModule\Attribute\Repositories\AttributeRepository  $channelRepository
     ...
     * @return \AppModule\Product\Helpers\Indexers\ElasticSearch\Product
     */
     ...
     * Returns filterable attribute values
     *
     * @param  \AppModule\Attribute\Contracts\Attribute  $attribute
     * @param  \AppModule\Product\Contracts\ProductAttributeValue
     * @return void
     */
