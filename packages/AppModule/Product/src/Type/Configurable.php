...
use AppModule\Admin\Validations\ConfigurableUniqueSku;
use AppModule\Checkout\Models\CartItem as CartItemModel;
use AppModule\Product\DataTypes\CartItemValidationResult;
use AppModule\Product\Facades\ProductImage;
use AppModule\Product\Helpers\Indexers\Price\Configurable as ConfigurableIndexer;
...
class Configurable extends AbstractType
{
     ...
     * Get default variant.
     *
     * @return \AppModule\Product\Models\Product
     */
     ...
     *
     * @param  \AppModule\Checkout\Contracts\CartItem  $cartItem
     * @return bool
     */
     ...
     *
     * @param  \AppModule\Customer\Contracts\Wishlist  $item
     * @return bool
     */
    ...
    {
        $childProduct = app('AppModule\Product\Repositories\ProductRepository')->find($data['selected_configurable_option']);
     ...
     * @return \AppModule\Checkout\Contracts\CartItem|\AppModule\Sales\Contracts\OrderItem|\AppModule\Sales\Contracts\InvoiceItem|\AppModule\Sales\Contracts\ShipmentItem|\AppModule\Customer\Contracts\Wishlist
     */
     ...
     *
     * @param  \AppModule\Customer\Contracts\Wishlist|\AppModule\Checkout\Contracts\CartItem  $item
     * @return array
     */
    public function getBaseImage($item)
    {
        ...
        if ($item instanceof \AppModule\Customer\Contracts\Wishlist) {
     ...
     *
     * @param  \AppModule\Product\Type\CartItem  $item
