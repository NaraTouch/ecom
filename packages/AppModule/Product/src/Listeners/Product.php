...
use AppModule\Product\Repositories\ProductGroupedProductRepository;
use AppModule\Product\Helpers\Indexers\{Inventory, Price, ElasticSearch, Flat};
...
class Product
{
     ...
     * @param  \AppModule\Product\Repositories\ProductGroupedProductRepository  $productGroupedProductRepository
     * @return void
     */
