...
namespace AppModule\Product\Http\Controllers;

use Illuminate\Support\Facades\Event;
use Illuminate\Support\Facades\Storage;
use AppModule\Category\Repositories\CategoryRepository;
use AppModule\Attribute\Repositories\AttributeFamilyRepository;
use AppModule\Inventory\Repositories\InventorySourceRepository;
...
use AppModule\Admin\DataGrids\ProductDataGrid;
use AppModule\Product\Helpers\ProductType;
use AppModule\Product\Http\Requests\ProductForm;
use AppModule\Product\Http\Requests\InventoryRequest;
use AppModule\Core\Contracts\Validations\Slug;
...
class ProductController extends Controller
{
     ...
     * @param  \AppModule\Attribute\Repositories\AttributeFamilyRepository  $attributeFamilyRepository
     * @param  \AppModule\Inventory\Repositories\InventorySourceRepository  $inventorySourceRepository
     * @param  \AppModule\Product\Repositories\ProductRepository  $productRepository
     * @param  \AppModule\Product\Repositories\ProductAttributeValueRepository  $productAttributeValueRepository
