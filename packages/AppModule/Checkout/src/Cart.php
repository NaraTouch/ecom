...
namespace AppModule\Checkout;

use Exception;
use Illuminate\Support\Arr;
use Illuminate\Support\Facades\Event;
use AppModule\Checkout\Models\CartAddress;
use AppModule\Checkout\Models\Cart as CartModel;
use AppModule\Checkout\Models\CartPayment;
use AppModule\Checkout\Repositories\CartAddressRepository;
use AppModule\Checkout\Repositories\CartItemRepository;
use AppModule\Checkout\Repositories\CartRepository;
use AppModule\Checkout\Traits\CartCoupons;
use AppModule\Checkout\Traits\CartTools;
use AppModule\Checkout\Traits\CartValidators;
use AppModule\Customer\Repositories\CustomerAddressRepository;
use AppModule\Customer\Repositories\WishlistRepository;
use AppModule\Product\Repositories\ProductRepository;
use AppModule\Shipping\Facades\Shipping;
use AppModule\Tax\Helpers\Tax;
...
class Cart
{
    ...
    /**
     * @var \AppModule\Checkout\Contracts\Cart
     */
    private $cart;
     ...
     *
     * @param  \AppModule\Checkout\Repositories\CartRepository  $cartRepository
     * @param  \AppModule\Checkout\Repositories\CartItemRepository  $cartItemRepository
     * @param  \AppModule\Checkout\Repositories\CartAddressRepository  $cartAddressRepository
     ...
     * @param  \AppModule\Customer\Repositories\WishlistRepository  $wishlistRepository
     * @param  \AppModule\Customer\Repositories\CustomerAddressRepository  $customerAddressRepository
     * @return void
     */
     ...
     * Returns cart.
     *
     * @return \AppModule\Checkout\Contracts\Cart|null
     */
     ...
     * @return \AppModule\Checkout\Contracts\Cart|null
     */
    public function getCart(): ?\AppModule\Checkout\Contracts\Cart
    {
        if ($this->cart) {
            return $this->cart;
        }
     ...
     *
     * @param \AppModule\Checkout\Contracts\Cart
     * @return  void
     */
     ...
     * @return \AppModule\Checkout\Contracts\CartItem|void
     */
     ...
     * @param  int  $productId
     * @param  array  $data
     * @return \AppModule\Checkout\Contracts\Cart|string|array
     * @throws Exception
     */
     ...
     *
     * @return \AppModule\Checkout\Models\Cart|null
     */
     ...
     * @return \AppModule\Checkout\Contracts\CartPayment
     */
     ...
     *
     * @param \AppModule\Checkout\Contracts\CartItem $item
     * @return bool
     */
    private function isCartItemInactive(\AppModule\Checkout\Contracts\CartItem $item): bool
    {
     ...
     * @return array
     */
    private function gatherBillingAddress($data, \AppModule\Checkout\Models\Cart $cart): array
    {
        $customerAddress = [];
     ...
     *
     * @param  array  $data
     * @param  \AppModule\Checkout\Cart|null  $cart
     * @return array
     */
    private function gatherShippingAddress($data, \AppModule\Checkout\Models\Cart $cart): array
    {
        $customerAddress = [];
    ...
    private function linkAddresses(
        \AppModule\Checkout\Models\Cart $cart,
