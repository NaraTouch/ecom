...
use AppModule\Sales\Database\Factories\OrderAddressFactory;
use AppModule\Sales\Contracts\OrderAddress as OrderAddressContract;
use Illuminate\Database\Eloquent\Builder;

/**
 * Class OrderAddress
 *
 * @package AppModule\Sales\Models
 *
