...
use AppModule\Sales\Contracts\Invoice as InvoiceContract;
use AppModule\Sales\Traits\PaymentTerm;
use AppModule\Sales\Database\Factories\InvoiceFactory;
use Illuminate\Database\Eloquent\Relations\BelongsTo;
use Illuminate\Database\Eloquent\Factories\HasFactory;
use AppModule\Sales\Traits\InvoiceReminder;
